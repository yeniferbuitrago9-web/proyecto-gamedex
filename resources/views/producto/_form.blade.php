...
<div class="space-y-4">
    ...
    <div>
        <label class="block text-base font-medium mb-1">Descripción</label>
      ...
      <div>
            <label class="block text-base font-medium mb-1">Precio *</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label class="block text-base font-medium mb-1">Cantidad *</label>
         ...
         <div>
            <label class="block text-base font-medium mb-1">Garantia *</label>
         ...
         <div>
            <label class="block text-base font-medium mb-1">Categoria *</label>
...
<br>
    <div class="mb-4">
    <label for="imagen" class="block text-base font-medium mb-1">Imagen del producto</label>
